    ...
    <>
      <div style={style} ref={setNodeRef}>
        ...
        >
          ...
          {onClick && (
            <button
              className="absolute bottom-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity bg-background border rounded p-1.5 text-xs hover:bg-muted z-10"
              onClick={(e) => {
                e.preventDefault();
                e.stopPropagation();
                onClick();
